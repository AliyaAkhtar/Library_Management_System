...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->panel1->Size = System::Drawing::Size(545, 464);
			...
			this->btn_signup->Size = System::Drawing::Size(161, 42);
			this->btn_signup->TabIndex = 9;
			this->btn_signup->Text = L"Sign Up";
			this->btn_signup->UseVisualStyleBackColor = true;
			this->btn_signup->Click += gcnew System::EventHandler(this, &MyForm10::btn_signup_Click);
			// 
			// tb_password
			// 
			...
			this->tb_password->Size = System::Drawing::Size(180, 32);
			...
			this->tb_email->Size = System::Drawing::Size(180, 32);
			...
			this->tb_name->Size = System::Drawing::Size(180, 32);
			...
			this->pictureBox1->Location = System::Drawing::Point(544, 0);
			...
			this->ClientSize = System::Drawing::Size(910, 463);
...
#pragma endregion
	private: System::Void btn_signup_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		std::ofstream outFile("C:/Users/LAPTOP WORLD/Desktop/studentSignup_records.txt", std::ios_base::app);
